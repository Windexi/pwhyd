...
MapGroup_NewBark:
	...
	map PlayersHouse1F, TILESET_CAVE, INDOOR, NEW_BARK_TOWN, MUSIC_DARK_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, NEW_BARK_TOWN, MUSIC_DARK_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ElmsHouse2F, TILESET_PLAYERS_ROOM, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map GuideGentsHouse, TILESET_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
