...
; PWHYD EVENTS
	...
	const EVENT_DEFAULT_OAK_IN_LAB
	const EVENT_KNOCKED_OAK_IN_LAB
	const EVENT_NEW_BARK_INTRO_FINISHED
	const EVENT_LETS_BE_FRIENDS
	const EVENT_ROUTE29_HIDDEN_ITEM
	
; PWHYD PEOPLE
	const EVENT_MEET_ADRIAN
...
; Johto hidden items
	...
	const EVENT_ROUTE_30_HIDDEN_SUPER_POTION
